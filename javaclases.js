...
console.log('==========================================================');
/*console.log('estoy en el archivo javascript')
...
console.log(nombre);
 ...
 + apellido+"y vivo en la provincia de "+ provincia);
...
document.getElementById("Day").innerHTML = 'Today is: ' + dayList[day] + '<br>';
...
document.getElementById("Time").innerHTML = 'The time is: ' + hour + ':' + minute + ':' + second + prepand;*/